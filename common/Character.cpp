...
vector<DestructibleNode *> nodes;
vector<DestructibleFace *> surfaces;
vector<DestructibleBond *> bonds;
vector<DestructibleCell *> cells;
vector<DestructibleFace *> fragments;
...
void Character::DestructibleRenderPass() {
...
/*        explode = true;
    ...
    numVertices = (numSurfaceVertices + fragments.size()*3)/4;
...
void Character::DestructibleRender() {
